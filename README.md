...
| `notebook/verification.ipynb` | Symbolic and numerical verification of every claim in the paper. |
| `notebook/verification_executed.ipynb` | The same notebook with outputs, readable without running it. |
...
Please cite the article once published. Until then, cite this repository and note that the work is not
yet peer reviewed.
